## Differential Expression Analyses for All Visits w/out Neutrophil Correction #
...
de_analysis <- function(cases, controls, counts, genes, min = 10) {
  ...
  design <- model.matrix(~ 0+case + sex  + ageSquared + mrnaBases)
...
write_tsv(df, "DE_noNeut/limmaResults/case_v_control_PPMI_limmaResults.tsv")
...
df <- de_analysis(cases, controls, countTable, genes.anno)
write_tsv(df, "DE_noNeut/limmaResults/case_v_control_PDBP_limmaResults.tsv")
...
df <- de_analysis(cases, controls, countTable, genes.anno)
write_tsv(df, "DE_noNeut/limmaResults/case_v_control_All_limmaResults.tsv")
...
write_tsv(df, "DE_noNeut/limmaResults/ipd_v_control_PPMI_limmaResults.tsv")
...
df <- de_analysis(cases, controls, countTable, genes.anno)
write_tsv(df, "DE_noNeut/limmaResults/ipd_v_control_PDBP_limmaResults.tsv")
...
df <- de_analysis(cases, controls, countTable, genes.anno)
write_tsv(df, "DE_noNeut/limmaResults/ipd_v_control_All_limmaResults.tsv")
...
df <- de_analysis(cases, controls, countTable, genes.anno, min = 30)
write_tsv(df, "DE_noNeut/limmaResults/GBA+_v_control_PPMI_limmaResults.tsv")
...
df <- de_analysis(cases, controls, countTable, genes.anno)
write_tsv(df, "DE_noNeut/limmaResults/GBA+_v_control_PDBP_limmaResults.tsv")
...
df <- de_analysis(cases, controls, countTable, genes.anno, min = 20)
write_tsv(df, "DE_noNeut/limmaResults/GBA+_v_control_All_limmaResults.tsv")
...
df <- de_analysis(cases, controls, countTable, genes.anno)
write_tsv(df, "DE_noNeut/limmaResults/LRRK2+_v_control_PPMI_limmaResults.tsv")
...
write_tsv(df, "DE_noNeut/limmaResults/LRRK2+_v_control_PDBP_limmaResults.tsv")
...
df <- de_analysis(cases, controls, countTable, genes.anno, min = 20)
write_tsv(df, "DE_noNeut/limmaResults/LRRK2+_v_control_All_limmaResults.tsv")
...
write_tsv(df, "DE_noNeut/limmaResults/LRRK2+_v_LRRK2-_PPMI_limmaResults.tsv")
...
write_tsv(df, "DE_noNeut/limmaResults/LRRK2+_v_LRRK2-_PDBP_limmaResults.tsv")
...
write_tsv(df, "DE_noNeut/limmaResults/LRRK2+_v_LRRK2-_All_limmaResults.tsv")
...
df <- de_analysis(cases, controls, countTable, genes.anno, min = 100)
write_tsv(df, "DE_noNeut/limmaResults/SNCA+_v_control_PPMI_limmaResults.tsv")
