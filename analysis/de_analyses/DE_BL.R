### Differential Expression Analyses for BL Visits w/ Neutrophil Correction ####
...
sample_meta <- sample_meta[sample_meta$visit_month %in% c(0),]
...
write_tsv(df, "DE_BL/limmaResults/case_v_control_PPMI_limmaResults.tsv")
...
df <- de_analysis(cases, controls, countTable, genes.anno)
write_tsv(df, "DE_BL/limmaResults/case_v_control_PDBP_limmaResults.tsv")
...
df <- de_analysis(cases, controls, countTable, genes.anno)
write_tsv(df, "DE_BL/limmaResults/case_v_control_All_limmaResults.tsv")
...
write_tsv(df, "DE_BL/limmaResults/ipd_v_control_PPMI_limmaResults.tsv")
...
df <- de_analysis(cases, controls, countTable, genes.anno)
write_tsv(df, "DE_BL/limmaResults/ipd_v_control_PDBP_limmaResults.tsv")
...
df <- de_analysis(cases, controls, countTable, genes.anno)
write_tsv(df, "DE_BL/limmaResults/ipd_v_control_All_limmaResults.tsv")
...
write_tsv(df, "DE_BL/limmaResults/GBA+_v_control_PPMI_limmaResults.tsv")
...
df <- de_analysis(cases, controls, countTable, genes.anno)
write_tsv(df, "DE_BL/limmaResults/GBA+_v_control_PDBP_limmaResults.tsv")
...
df <- de_analysis(cases, controls, countTable, genes.anno, min = 20)
write_tsv(df, "DE_BL/limmaResults/GBA+_v_control_All_limmaResults.tsv")
...
df <- de_analysis(cases, controls, countTable, genes.anno)
write_tsv(df, "DE_BL/limmaResults/LRRK2+_v_control_PPMI_limmaResults.tsv")
...
write_tsv(df, "DE_BL/limmaResults/LRRK2+_v_control_PDBP_limmaResults.tsv")
...
df <- de_analysis(cases, controls, countTable, genes.anno, min = 20)
write_tsv(df, "DE_BL/limmaResults/LRRK2+_v_control_All_limmaResults.tsv")
...
write_tsv(df, "DE_BL/limmaResults/LRRK2+_v_LRRK2-_PPMI_limmaResults.tsv")
...
write_tsv(df, "DE_BL/limmaResults/LRRK2+_v_LRRK2-_PDBP_limmaResults.tsv")
...
write_tsv(df, "DE_BL/limmaResults/LRRK2+_v_LRRK2-_All_limmaResults.tsv")
...
write_tsv(df, "DE_BL/limmaResults/SNCA+_v_control_PPMI_limmaResults.tsv")
