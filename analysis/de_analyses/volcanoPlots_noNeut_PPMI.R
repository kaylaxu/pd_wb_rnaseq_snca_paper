...
########### Case v Control #########
df <- read.table(file="DE_noNeut/limmaResults/case_v_control_PPMI_limmaResults.tsv", header=TRUE, sep="\t", check.names=FALSE)
...
volPlot <- EnhancedVolcano(df,
                           ...
                           x = 'logFC',
                           y = 'P.Value',
                           title = 'Case vs Control - PPMI w/out Neutrophil Correction',
...
ggsave('DE_noNeut/volcanoPlots/case_v_control_PPMI_EVol.jpeg',
       volPlot,
...
volPlot
ggsave('DE_noNeut/volcanoPlots/case_v_control_PPMI_EVol_mito.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
ggsave('DE_noNeut/blood_cell_plots/case_v_control_PPMI_blood_genes.jpeg',
       plot,
       dpi = 300, width = 6, height = 3)


########### IPD v Control #########
df <- read.table(file="DE_noNeut/limmaResults/ipd_v_control_PPMI_limmaResults.tsv", header=TRUE, sep="\t", check.names=FALSE)
...
volPlot <- EnhancedVolcano(df,
                           ...
                           x = 'logFC',
                           y = 'P.Value',
                           title = 'IPD vs Control - PPMI w/out Neutrophil Correction',
                           ylab = bquote(~-Log[10]~italic(P)),
                           colAlpha = 0.6,
                           pCutoffCol = 'adj.P.Val',
                           pCutoff = 0.05,
...
ggsave('DE_noNeut/volcanoPlots/ipd_v_control_PPMI_EVol.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
names(keyvals)[which(df$category == "Mitochondria gene")] <- 'Pathway Genes'
geneLabels <- df[which((df$category == "PD causal variant" | df$category == 'Mitochondria gene')& df$significance != 'insignificant'),]$gene_name
volPlot <- createVolcanoCustom(df, 'IPD vs Control - PPMI w/out Neutrophil Correction', keyvals, geneLabels, c(-0.46,0.44), c(0,35))
volPlot
ggsave('DE_noNeut/volcanoPlots/ipd_v_control_PPMI_EVol_mito.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
ggsave('DE_noNeut/blood_cell_plots/ipd_v_control_PPMI_blood_genes.jpeg',
       plot,
       dpi = 300, width = 6, height = 3)


########### GBA+ v Control #########
df <- read.table(file="DE_noNeut/limmaResults/GBA+_v_control_PPMI_limmaResults.tsv", header=TRUE, sep="\t", check.names=FALSE)
...
volPlot <- EnhancedVolcano(df,
                           ...
                           x = 'logFC',
                           y = 'P.Value',
                           title = 'GBA+ vs Control - PPMI w/out Neutrophil Correction',
                           ylab = bquote(~-Log[10]~italic(P)),
                           colAlpha = 0.6,
                           pCutoffCol = 'adj.P.Val',
                           pCutoff = 0.05,
...
ggsave('DE_noNeut/volcanoPlots/GBA+_v_control_PPMI_EVol.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
geneLabels <- df[which((df$category == "PD causal variant" | df$category == 'Mitochondria gene')& df$significance != 'insignificant'),]$gene_name
volPlot <- createVolcanoCustom(df, 'GBA+ vs Control - PPMI w/out Neutrophil Correction', keyvals, geneLabels, c(-0.69,0.73), c(0,35))
volPlot
ggsave('DE_noNeut/volcanoPlots/GBA+_v_control_PPMI_EVol_mito.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
ggsave('DE_noNeut/blood_cell_plots/GBA+_v_control_PPMI_blood_genes.jpeg',
       plot,
       dpi = 300, width = 6, height = 3)
...
########### LRRK2+ v Control #########
df <- read.table(file="DE_noNeut/limmaResults/LRRK2+_v_control_PPMI_limmaResults.tsv", header=TRUE, sep="\t", check.names=FALSE)
...
volPlot <- EnhancedVolcano(df,
                           ...
                           x = 'logFC',
                           y = 'P.Value',
                           title = 'LRRK2+ vs Control - PPMI w/out Neutrophil Correction',
                           ylab = bquote(~-Log[10]~italic(P)),
                           colAlpha = 0.6,
                           pCutoffCol = 'adj.P.Val',
                           pCutoff = 0.05,
...
ggsave('DE_noNeut/volcanoPlots/LRRK2+_v_control_PPMI_EVol.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
names(keyvals)[which(df$category == "Mitochondria gene")] <- 'Mitochondria Genes'
geneLabels <- df[which((df$category == "PD causal variant" | df$category == 'Mitochondria gene')& df$significance != 'insignificant'),]$gene_name
volPlot <- createVolcanoCustom(df, 'LRRK2+ vs Control - PPMI w/out Neutrophil Correction', keyvals, geneLabels, c(-1.1,1.1), c(0,70))
volPlot
ggsave('DE_noNeut/volcanoPlots/LRRK2+_v_control_PPMI_EVol_mito.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
ggsave('DE_noNeut/blood_cell_plots/LRRK2+_v_control_PPMI_blood_genes.jpeg',
       plot,
       dpi = 300, width = 6, height = 3)
...
########### LRRK2+ v LRRK2- #########
df <- read.table(file="DE_noNeut/limmaResults/LRRK2+_v_LRRK2-_PPMI_limmaResults.tsv", header=TRUE, sep="\t", check.names=FALSE)
...
volPlot <- EnhancedVolcano(df,
                           ...
                           x = 'logFC',
                           y = 'P.Value',
                           title = 'LRRK2+ vs LRRK2- - PPMI w/out Neutrophil Correction',
                           ylab = bquote(~-Log[10]~italic(P)),
                           colAlpha = 0.6,
                           pCutoffCol = 'adj.P.Val',
                           pCutoff = 0.05,
...
ggsave('DE_noNeut/volcanoPlots/LRRK2+_v_LRRK2-_PPMI_EVol.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
names(keyvals)[which(df$category == "Mitochondria gene")] <- 'Mitochondria Genes'
geneLabels <- df[which((df$category == "PD causal variant" | df$category == 'Mitochondria gene')& df$significance != 'insignificant'),]$gene_name
volPlot <- createVolcanoCustom(df, 'LRRK2+ v LRRK2- - PPMI w/out Neutrophil Correction', keyvals, geneLabels, c(-1.36, 0.75), c(0,60))
volPlot
ggsave('DE_noNeut/volcanoPlots/LRRK2+_v_LRRK2-_PPMI_EVol_mito.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
ggsave('DE_noNeut/blood_cell_plots/LRRK2+_v_LRRK2-_PPMI_blood_genes.jpeg',
       plot,
       dpi = 300, width = 6, height = 3)
