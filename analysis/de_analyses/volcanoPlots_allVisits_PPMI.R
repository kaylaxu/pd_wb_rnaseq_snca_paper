...
########### Case v Control #########
df <- read.table(file="DE_allVisits/limmaResults/case_v_control_PPMI_limmaResults.tsv", header=TRUE, sep="\t", check.names=FALSE)
...
ggsave('DE_allVisits/volcanoPlots/case_v_control_PPMI_EVol.jpeg',
       volPlot,
...
volPlot <- createVolcanoCustom(df, 'Case vs Control - PPMI', keyvals, geneLabels, c(-0.5,0.7), c(0,20))
volPlot
ggsave('DE_allVisits/volcanoPlots/case_v_control_PPMI_EVol_mito.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
ggsave('DE_allVisits/blood_cell_plots/case_v_control_PPMI_blood_genes.jpeg',
       plot,
...
########### IPD v Control #########
df <- read.table(file="DE_allVisits/limmaResults/ipd_v_control_PPMI_limmaResults.tsv", header=TRUE, sep="\t", check.names=FALSE)
...
ggsave('DE_allVisits/volcanoPlots/ipd_v_control_PPMI_EVol.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
names(keyvals)[which(df$category == "Mitochondria gene")] <- 'Mitochondria Genes'
geneLabels <- df[which((df$category == "PD causal variant")& df$significance != 'insignificant'),]$gene_name
volPlot <- createVolcanoCustom(df, 'IPD vs Control - PPMI', keyvals, geneLabels, c(-0.6,0.55), c(0,13))
volPlot
ggsave('DE_allVisits/volcanoPlots/ipd_v_control_PPMI_EVol_mito.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
ggsave('DE_allVisits/blood_cell_plots/ipd_v_control_PPMI_blood_genes.jpeg',
       plot,
       dpi = 300, width = 6, height = 3)
...
########### GBA+ v Control #########
df <- read.table(file="DE_allVisits/limmaResults/GBA+_v_control_PPMI_limmaResults.tsv", header=TRUE, sep="\t", check.names=FALSE)
...
ggsave('DE_allVisits/volcanoPlots/GBA+_v_control_PPMI_EVol.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
names(keyvals)[which(df$category == "Mitochondria gene")] <- 'Mitochondria Genes'
geneLabels <- df[which((df$category == "PD causal variant")& df$significance != 'insignificant'),]$gene_name
volPlot <- createVolcanoCustom(df, 'GBA+ vs Control - PPMI', keyvals, geneLabels, c(-1.1,1.6), c(0,20))
volPlot
ggsave('DE_allVisits/volcanoPlots/GBA+_v_control_PPMI_EVol_mito.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
ggsave('DE_allVisits/blood_cell_plots/GBA+_v_control_PPMI_blood_genes.jpeg',
       plot,
       dpi = 300, width = 6, height = 3)


########### LRRK2+ v Control #########
df <- read.table(file="DE_allVisits/limmaResults/LRRK2+_v_control_PPMI_limmaResults.tsv", header=TRUE, sep="\t", check.names=FALSE)
...
ggsave('DE_allVisits/volcanoPlots/LRRK2+_v_control_PPMI_EVol.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
names(keyvals)[which(df$category == "Mitochondria gene")] <- 'Mitochondria Genes'
geneLabels <- df[which((df$category == "PD causal variant" )& df$significance != 'insignificant'),]$gene_name
volPlot <- createVolcanoCustom(df, 'LRRK2+ vs Control - PPMI', keyvals, geneLabels, c(-2.1,1.9), c(0,52))
volPlot
ggsave('DE_allVisits/volcanoPlots/LRRK2+_v_control_PPMI_EVol_mito.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
ggsave('DE_allVisits/blood_cell_plots/LRRK2+_v_control_PPMI_blood_genes.jpeg',
       plot,
       dpi = 300, width = 6, height = 3)


########### LRRK2+ v LRRK2- #########
df <- read.table(file="DE_allVisits/limmaResults/LRRK2+_v_LRRK2-_PPMI_limmaResults.tsv", header=TRUE, sep="\t", check.names=FALSE)
...
ggsave('DE_allVisits/volcanoPlots/LRRK2+_v_LRRK2-_PPMI_EVol.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
names(keyvals)[which(df$category == "Mitochondria gene")] <- 'Mitochondria Genes'
geneLabels <- df[which((df$category == "PD causal variant" )& df$significance != 'insignificant'),]$gene_name
volPlot <- createVolcanoCustom(df, 'LRRK2+ vs LRRK2- - PPMI', keyvals, geneLabels, c(-1.45, 1.56), c(0,45))
volPlot
ggsave('DE_allVisits/volcanoPlots/LRRK2+_v_LRRK2-_PPMI_EVol_mito.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
ggsave('DE_allVisits/blood_cell_plots/LRRK2+_v_LRRK2-_PPMI_blood_genes.jpeg',
       plot,
       dpi = 300, width = 6, height = 3)
