...
ggsave('DE_allVisits/volcanoPlots/GBA+_v_GBA-_All_EVol.jpeg',
       volPlot,
       dpi = 300, width = 6, height = 8)
...
ggsave('DE_allVisits/blood_cell_plots/GBA+_v_GBA-_All_blood_genes.jpeg',
       plot,
       dpi = 300, width = 6, height = 3)
...
ggsave('DE_allVisits/blood_cell_plots/GBA+_v_GBA-_All_blood_genes_All.jpeg',
       plot,
       dpi = 300, width = 6, height = 3)
